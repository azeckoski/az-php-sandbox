...
<?php } ?>
	<br/>
	<a style="font-size:.8em;" href="<?= $TOOL_URL ?>/index.php">Main Page</a> -
	<a style="font-size:.8em;" href="<?= $TOOL_URL ?>/registration/index.php">Registration</a> -
	<a style="font-size:.8em;" href="<?= $TOOL_URL ?>/proposals/index.php">Proposals</a>
  	<?= $EXTRA_LINKS ?>
	</td>
...
<?php if ($User->pk > 0) { ?>
 ...
 <?php if ($User->checkPerm("admin_conference")) { ?>
  	<a style="font-size:.8em;" href="<?= $TOOL_URL ?>/admin/index.php">Tool Admin</a> - 
<?php } ?>

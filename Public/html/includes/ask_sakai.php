...
?>
<form action="http://www.sakaitest.org/index.php?option=com_content&task=view&id=260&Itemid=487" method="post" name="jiraform" enctype="multipart/form-data">
...
?>
<form action="http://www.sakaiproject.org/index.php?option=com_content&task=view&id=260" method="post" name="jiraform" enctype="multipart/form-data">
<table width="98%" cellspacing="3" cellpadding="7" class="jiraform"><tbody><tr><td>&nbsp;</td><td class="small"><strong>* </strong> Required<br>
 <br>

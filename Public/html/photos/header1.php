  ...
  <tbody>
    ...
    <tr class="mainPageContent">
      <td class="centerContent" width="100%"><div id="photos"><div id="menu">
          <table width=100%>
            <tr>
              <td  valign=top class="viewmenu"><div><strong>Display photos by: </strong><br /><ul><li>
              ...
              <td valign=top><div><a href=add_photo.php>
                  Submit Entry</a></div><div><a href=edit_entry.php>
                  Edit Entry</a></div></td>

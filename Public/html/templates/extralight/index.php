  ...
  <tr>
    <td class="mainHeader" width="100%" ><table  border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <img src="<?php echo $mosConfig_live_site;?>/images/stories/sakaiLogo_files/logoslate160x89.jpg" border="0" alt="Sakai Logo" /></a></td>
          <td  id="searchbox"><div style="padding: 3px; background:#fff; color:#000;"> 
          <a href="http://www.proyectosakai.org/" title="Spanish mirror of sakaiproject.org"><img src="images/stories/external_icon.gif" /> Espa&ntilde;ol &nbsp; </a></div><br/><br/><strong>SEARCH</strong>
    ...
    <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
        <tr align="center" valign="top">
          ...
          <td class="centerContent" border="0" align="center" style="padding: 0px 0px;">
              ...
              <tr>
                <td width="100%"><?php mosLoadModules ('user1'); ?>
                  </td>
                  </tr></table>
              <?php } ?>

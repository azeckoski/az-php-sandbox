...
<div id="container">
 <div id=header>
			...
			<div id=confbanner>
					...
					<div style="color:#fff;"><strong>SEARCH</strong>&nbsp; &nbsp;</div>
        <div style="float:left; clear:right; " > <form  action="http://www.google.com/u/sakaiproject" method="get" target="_blank">
...
<input type="hidden" name="sa" value="sa"> </form>
           ...
           <div style="float:left; color: #fff;"> &nbsp;or &nbsp; &nbsp;</div>
             <div style="float:left;"><form action='<?php echo sefRelToAbs("index.php"); ?>' method='post'>

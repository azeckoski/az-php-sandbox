...
//
// *************************************************
$menu_type = "module";				// splitmenu | supersucker | suckerfish  | module
  					...
  					<div id="mainbg-4">
  						<div id="mainbg-5">
           					...
           					<div id="header">
			          			...
			          			<a href="<?php echo $mosConfig_live_site;?>" title=""><span id="logo"> &nbsp; </span></a><span id="confTitle">7th Sakai Conference<br/>Amsterdam, The Netherlands<br/>June 12-14, 2007</span><span class=headerimages><img src="templates/amsterdam/images/amsterdam_004.jpg" align=right /><img src="templates/amsterdam/images/magerebrug1.jpg" align=right /></span>
			          			<div id="top">

...
if ($order=="id_asc"){
 ...
 $sql = "SELECT * FROM cfp_austin_present_test  where approved='1' or approved= '2' or approved='3'  ORDER BY id asc";
	  	  $reportname='Ordered by session id';
}
if ($order=="id_desc"){

 $sql = "SELECT * FROM cfp_austin_present_test  where approved='1'  or approved= '2' or approved='3'  ORDER BY id desc";
	  	  $reportname='Ordered by session id';
}

if ($order=="speaker_asc"){

 $sql = "SELECT * FROM cfp_austin_present_test  where approved='1' or approved= '2' or approved='3'  ORDER BY lastname asc";
	  	  $reportname="Ordered by primary speaker's last name";
}
if ($order=="speaker_desc"){

 $sql = "SELECT * FROM cfp_austin_present_test  where approved='1' or approved= '2' or approved='3'   ORDER BY lastname desc";
	  	  $reportname="Ordered by primary speaker's last name";
}
...
if ($order=="title_asc"){
 ...
 $sql = "SELECT * FROM cfp_austin_present_test  where approved='1'  or approved= '2' or approved='3'  ORDER BY p_title asc";
	  	  $reportname='Ordered by title';
}
if ($order=="title_desc"){

 $sql = "SELECT * FROM cfp_austin_present_test  where approved='1' or approved= '2' or approved='3'  ORDER BY p_title desc";
	  	  $reportname='Ordered by title';
}
if ($order==""){

 $sql = "SELECT * FROM cfp_austin_present_test  where approved='1' or approved= '2' or approved='3'  ORDER BY session_time asc";
...
if ($order=="time_desc"){
 ...
 $sql = "SELECT * FROM cfp_austin_present_test  where approved='1' or approved= '2' or approved='3'   ORDER BY session_time desc";
	  	  $reportname='Ordered by date/time';
}

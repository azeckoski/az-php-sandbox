...
/** common */
DEFINE('_LANGUAGE','en');
DEFINE('_NOT_AUTH','<br /><br />The item you are looking for is either no longer available<br /> or may require a user login to be viewed properly.');
...
DEFINE('_DATE_FORMAT_LC',"%Y-%b-%d"); //Uses PHP's strftime Command Format
DEFINE('_DATE_FORMAT_LC2',"%A, %d %B %Y %H:%M");
DEFINE('_SEARCH_BOX_site',' this site...');
DEFINE('_SEARCH_BOX_all',' all Sakai sites...');
DEFINE('_SEARCH_BOX_sakai',' sakaiproject.org...');

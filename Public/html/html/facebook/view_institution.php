  ...
  <tbody>
    ...
    <tr>
      <td><table id="searchBar1" bgcolor="#f3f3f3" border="0" width="100%">
          <tbody>
            <tr>
              <td class="searchBar"><span class="pathway"> <img src="../conferenceJune_05/regindex_files/arrow.png" height="9" width="9"> <span class="pathway"><a href="http://www.sakaiproject.org/index.php?option=com_content&task=view&id=243&Itemid=477">SEPP Conference</a> <img src="../conferenceJune_05/regindex_files/arrow.png" alt="arrow"> <a href="index.php">Facebook </a><img src="../conferenceJune_05/regindex_files/arrow.png" alt="arrow">- by institution</span> </span></td>
          ...
          <table width=100%>
            <tr>
              ...
              <div><ul>
               ...
               <li><img src="../conferenceJune_05/regindex_files/arrow.png" height="9" width="9"><a href=view_institution.php>Institution</a></li></ul></div></td>

...
<a href=view_institution.php> Institution</a><br /><br /><a href=printPhotos.php>Print Gallery of Large Images</a></p><p><a href=facebook.php><h3>Submit User Photo</h3></a></p>";
...
echo "<div id=label> <br />$first $last<br />$institution<br />$interests<br /></div></div>";

...
<td>
  ...
  <tr><td colspan=2><form name="ask_sakai"  method="post"  action="<?php echo $_SERVER['PHP_SELF'];?>">
            ...
            <select name="report" id="report">
		       ...
		       <option value="3">by Sakai Partners</option>
		       <option value="4">by Sakai Affiliates</option>
                <option value="5">by Conference</option>
                                <option value="6">by Tech</option>

                <option value="8">by Web</option>
                <option value="7">by Other</option>
...
case 3:
	  $sql = 'SELECT * FROM ask_sakai where category like "SEPP" ORDER BY date DESC';
	  	  $reportname='Sakai Partners Requests';
break;
case 4:

...
$sql="Select * from `cfp_vancouver_presentation` WHERE id='$user_id' ";
//test
//		$sql="Select * from `cfp_vancouver_presentation`";
$result= mysql_query($sql);
echo "$result <br />";
$resultsnumber=mysql_numrows($result);
$count   = "SELECT COUNT(*) AS numrows FROM cfp_vancouver_presentation";
...
//set up mail message
	...
	$msg .="Your proposal details are shown below.  You will receive one message for each presentation or technical demo you submitted.\r\n \r\n";

<?php
/**
* @version $Id: poll.php,v 1.7 2005/02/05 11:07:18 akede Exp $
* @package Mambo
* @subpackage Polls
...
function pollresult( $uid ) {
	...
	$query = "SELECT a.id, a.text, count( DISTINCT b.id ) AS hits, count( DISTINCT b.id )/COUNT( DISTINCT c.id )*100.0 AS percent"

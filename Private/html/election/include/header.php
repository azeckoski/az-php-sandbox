                ...
                <table class="contentpaneopen">
                  <tr>
                    <td valign="top" colspan="2"><div align="right" style="padding:4px;background:#eee;font-size:12pt;color:#000;">
                        ...
                        <a style="font-size:9pt;" href="<?=$CONF_URL ?>">Conference Home</a> - <a style="font-size:9pt;" href="../conference/registration/">Registration</a>  - <a style="font-size:9pt;" href="../conference/proposals/">Proposals</a>- <a style="font-size:9pt;" href="../conference/logos/">Logo Contest</a>
                        <?= $EXTRA_LINKS ?>
                      </div></td>
                  </tr>
                </table>

...
<?php include $ACCOUNTS_PATH.'include/Jun2007header.php'; // INCLUDE THE HEADER ?>


<?= $Message ?>

<div style="background:yellow;  border: 1px solid #336699; text-align:center;"><br/><h3>7th Sakai Conference, Amsterdam, The Netherlands</h2><br/><br/> </div>
...
?>
			...
			<tr class='list'>
				...
				<?php 		 if ($proposal['track']=="Teaching & Learning") {
					   	$trackclass="pedagogy";
					   }?>

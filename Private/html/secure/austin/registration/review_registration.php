...
echo"<table width=450px>";
			...
			echo"<tr><td colspan=2>Please verify that the following information is correct. <br /> Then click  on <strong>Continue</strong> to complete the payment process. <br /><br /><br /></td></tr>";

...
<div id="container">
 <div id=header>
			...
			<a href="index.php"></a>
					...
					<div id=topSearch><div align=left style="color:#fff; float:left;"><strong>SEARCH</strong>&nbsp; &nbsp;</div>
          <div style="float:left;" align=left><form style="padding:0; margin:0;" action='<?php echo sefRelToAbs("index.php"); ?>' method='post'>
              <input class="inputbox" type="text" name="searchword" size="20" value="<?php echo _SEARCH_BOX_sakai; ?>"  onblur="if(this.value=='') this.value='<?php echo _SEARCH_BOX_sakai; ?>';" onfocus="if(this.value=='<?php echo _SEARCH_BOX_sakai; ?>') this.value='';" />
              <input type="hidden" name="option" value="search" />
            </form></div><div style="float:left; color:#fff;" align=left> &nbsp; &nbsp; or  &nbsp; &nbsp; </div>
           <div style="float:left;" > <form action="http://www.google.com/u/sakaiproject" method="get" target="_blank">

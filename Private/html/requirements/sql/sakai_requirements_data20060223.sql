...
insert into requirements_data (jirakey,jiranum,summary,description,audience,component) values ('REQ-19','19','Make storage and display of assessment scores consistent','1: Scores should be stored and transmitted between tools (as opposed  <br/>
...
insert into requirements_data (jirakey,jiranum,summary,description,audience,component) values ('REQ-43','43','Instant Messaging','Instant Messaging support in Sakai is an oft requested feature.  There are a variety of approaches suggested.<br/>
<br/>
...
insert into requirements_data (jirakey,jiranum,summary,description,audience,component) values ('REQ-47','47','Tool Menu (Left-hand Buttons) Permission Senstive','The list of tools appearing in the left-hand menu should be senstive to the users permissions.  If they cannot access the content of the tool, because its permssions have been set that weay, then they should not see that tool in their list.','Researchers|Students|Instructors','Global ');
...
insert into requirements_data (jirakey,jiranum,summary,description,audience,component) values ('REQ-73','73','Specify AM/PM or 0-23 hour format sakai-wide','the hour format could be settable, either in sakai.properties, or on user preferences. AM/PM can be confusing for users not used to it.','Instructors|Researchers|Students','Preferences ');
...
insert into requirements_data (jirakey,jiranum,summary,description,audience,component) values ('REQ-75','75','Weighted Grades','- An instructor needs to be able to set - and adjust - the relative weighting of a column for computing a final score','Instructors','Gradebook ');
...
insert into requirements_data (jirakey,jiranum,summary,description,audience,component) values ('REQ-89','89','User Profile Tool','In the User Profile Tool, each Sakai user could upload:<br/>
...
insert into requirements_data (jirakey,jiranum,summary,description,audience,component) values ('REQ-99','99','User can restrict profile information based on system role','Requirements:<br/>
...
insert into requirements_data (jirakey,jiranum,summary,description,audience,component) values ('REQ-102','102','Use of middlename','In Dutch and other languages the use of ''Middlenames'' is quite important and is being used different depending on the situation.<br/>
An example:<br/>
...
insert into requirements_data (jirakey,jiranum,summary,description,audience,component) values ('REQ-104','104','Allow optional auto-create groups using class sections that may be in the site via a provider id','Along with REQ-40 and REQ-74 which add group control to other tools, as an option it would be useful to allow auto creating groups from the roster for each class section that might be in a site via a provider id. For example, if a site contained 3 rosters because the provider id was
<br/>
...
insert into requirements_data (jirakey,jiranum,summary,description,audience,component) values ('REQ-113','113','Accessibility--Title and Content Frames should be combined','Separate title and content frames creates a situation where tool headings are often redundant and navigation is cumbersome. For example, if a screen reader user has his JAWS settings on default, he will hear the following description:<br/>
<br/>
...
insert into requirements_data (jirakey,jiranum,summary,description,audience,component) values ('REQ-115','115','Online surveys and course evaluations','There are 2 use cases for a tool which can be used for surveys:<br/>
<br/>
...
insert into requirements_data (jirakey,jiranum,summary,description,audience,component) values ('REQ-116','116','Password recovery / lost password for guest accounts','Currently guest accounts can be added to Sakai. Guests will receive an email with their password, with which they can login and update their password (My Workspace / Account).<br/>
<br/>
...
insert into requirements_data (jirakey,jiranum,summary,description,audience,component) values ('REQ-118','118','Instant messaging support','There are many use cases for good support for and integration with instant messaging technologies (targetting specifically Jabber/XMPP). These include:<br/>
<br/>
...
insert into requirements_data (jirakey,jiranum,summary,description,audience,component) values ('REQ-119','119','Upload user photo','Presently, if a user wishes to add her photo to her profile, she needs to do the following:<br/>
<br/>
...
insert into requirements_data (jirakey,jiranum,summary,description,audience,component) values ('REQ-120','120','Improved Help tool','Two changes to the help tool:<br/>
<br/>
...
insert into requirements_data (jirakey,jiranum,summary,description,audience,component) values ('REQ-122','122','Add IP Filtering to Web Services','WSRP has a configurable IP filtering capability.  This same capability needs to be added to Sakai''s web services.','Sakai developers|Sakai administrators','Web Services ');
insert into requirements_data (jirakey,jiranum,summary,description,audience,component) values ('REQ-123','123','Support IMS Enterprise','This likely will take the form of finishing the IMS Enterprise Provider as a first step.  In addition, there may need to be a way to upload an IMS Enteirprise document, parse it and inject that information into Sakai.<br/>
<br/>
...
insert into requirements_data (jirakey,jiranum,summary,description,audience,component) values ('REQ-129','129','Integration with Learning Design and other Work Flow Engines','Refine the Sakai Architecture (likely the Entity Model) in oprder to support the workflow needs oa a learning design engine such as LAMS or Coppercore.  The requirements these engines have range form discovery of entityes, the timed use of entities during LD experiences, and the retrieval of information from entities.<br/>
<br/>
...
insert into requirements_data (jirakey,jiranum,summary,description,audience,component) values ('REQ-144','144','Distributed/Remote tool/components support','Use cases examples:<br/>
<br/>
...
<br/>
','Sakai administrators',' New Tool');
insert into requirements_data (jirakey,jiranum,summary,description,audience,component) values ('REQ-155','155','Disallow Users from Unjoining an Unjoinable Site','To disallow students to unjoin a course.<br/>
<br/>
...
insert into requirements_data (jirakey,jiranum,summary,description,audience,component) values ('REQ-158','158','Math symbols in rich text editor','Whichever html editor we use in future (HtmlArea at present), we would like to be able to add Math symbols to the content.','Sakai administrators|Sakai developers','WYSIWYG Widget ');
...
insert into requirements_data (jirakey,jiranum,summary,description,audience,component) values ('REQ-162','162','Institutional Providers','We would generally like providers that will allow a hybrid of the following:<br/>
&nbsp;&nbsp;calendar<br/>
&nbsp;&nbsp;content hosting<br/>
<br/>
...
insert into requirements_data (jirakey,jiranum,summary,description,audience,component) values ('REQ-196','196','Import should allow instructors to replace existing items with imported items','Goals:<br/>
...
insert into requirements_data (jirakey,jiranum,summary,description,audience,component) values ('REQ-197','197','Import should allow instructors to import section/group shell','Goals:<br/>
...
insert into requirements_data (jirakey,jiranum,summary,description,audience,component) values ('REQ-209','209','''Honor pledge'' specifics should be easily configurable per Sakai instance.','Allow an institution to use normal &quot;honor code&quot; langauage for thier institution.<br/>
...
insert into requirements_data (jirakey,jiranum,summary,description,audience,component) values ('REQ-210','210','Add Support for JSR-170 (Java Content Repository)','This is a long term effort and will need to be fit in within aa sequence of significant framework changes.  The rough approach should be to first evaluate possible solutions/implementations looking at Jakarta JackRabbit or other open source alternatives.<br/>
<br/>
...
insert into requirements_data (jirakey,jiranum,summary,description,audience,component) values ('REQ-211','211','Integrate Content Management Capability into Sakai','The Gateway page is pretty lame in general.  This is one of the reasons that Sakai cannot be used to support <a href="http://www.sakaiproject.org">www.sakaiproject.org</a>.  Sakai needs a content management capability that is nicely integrated into Sakai''s structure and organization.<br/>
<br/>
...
insert into requirements_data (jirakey,jiranum,summary,description,audience,component) values ('REQ-212','212','Search for users widget','Sakai users need to be able to search for other users where they need user information.  The search should include any user information that comes in to Sakai through SIS systems.
<br/>
...
insert into requirements_data (jirakey,jiranum,summary,description,audience,component) values ('REQ-213','213','Schedule should allow for creating new items in the context of the calendar.','Allow users to choose the date and time of an event in the context of the calendar (like most calendar systems).<br/>
<br/>
...
insert into requirements_data (jirakey,jiranum,summary,description,audience,component) values ('REQ-222','222','Improved Admin tools (Sites and Realms)','Improve admin tools:<br/>
<br/>
...
insert into requirements_data (jirakey,jiranum,summary,description,audience,component) values ('REQ-223','223','Global system announcement tool','We need a way of pushing a support/administrative announcement to all users immediately rather than relying only on the motd. Such a tool should be able to optionally be targeted to users on a particular app server or servers in a clustered environment. The message would be presented to the user on login or to those already logged in, in a popup. The message would only be delivered once, and would therefore have a start/end time. ','Instructors|Students|Staff (administrative)|Sakai administrators|Researchers',' New Tool|MOTD ');
insert into requirements_data (jirakey,jiranum,summary,description,audience,component) values ('REQ-224','224','Add feedback capability to Help tool','A feature on each help page to rate the helpfulness of the content will help improve the quality of help documentation.<br/>
<br/>
...
insert into requirements_data (jirakey,jiranum,summary,description,audience,component) values ('REQ-230','230','User tool: New features (order by more fields, search and paging)','In the &quot;Users&quot; tool in admin''s My Workspace, the users can be ordered<br/>
only by the Uid.<br/>
<br/>
...
insert into requirements_data (jirakey,jiranum,summary,description,audience,component) values ('REQ-232','232','Resources - greater granularity for permissions','Would like to be able to set permissions on folders to:<br/>
<br/>
...
insert into requirements_data (jirakey,jiranum,summary,description,audience,component) values ('REQ-236','236','Assignment tool improvements','Feature enhancements on Assignment tool:<br/>
...
insert into requirements_data (jirakey,jiranum,summary,description,audience,component) values ('REQ-240','240','Documentation: WSRP Architecture Document','We need an architecture document that deccribes how WSRP is architected and how it works in the system.<br/>
<br/>
docs/architecture','Sakai developers','Documentation (other than Help)');
insert into requirements_data (jirakey,jiranum,summary,description,audience,component) values ('REQ-243','243','Documentation: Need web services architecture document','docs/architecture<br/>
<br/>
...
insert into requirements_data (jirakey,jiranum,summary,description,audience,component) values ('REQ-253','253','Assessment Tools should integrate with other Sakai Tools (i.e., Announcements, Schedule)','From REQ-235:<br/>
<br/>
...
insert into requirements_data (jirakey,jiranum,summary,description,audience,component) values ('REQ-255','255','appointment sign-up capability for Schedule tool','Several faculty have wanted to use the Schedule tool to:<br/>
...
insert into requirements_data (jirakey,jiranum,summary,description,audience,component) values ('REQ-257','257','Allow public access w/o invite','Friendly URL for public resources.  <br/>
...
insert into requirements_data (jirakey,jiranum,summary,description,audience,component) values ('REQ-261','261','Announcement links have to be opened to be read.','The whole message should be shown as the default so that the user does not have to click to open every announcement.  The default number of messages should be the past 7 days.','Students|Instructors|Researchers','Announcements ');
...
insert into requirements_data (jirakey,jiranum,summary,description,audience,component) values ('REQ-263','263','Ability to rename a user and/or move one user''s data to another user','We are in the process of changing how we issue userids to faculty and students.  It would be nice if there was a simple way to rename a user within Sakai and/or be able to move data from the old account to the new one.','Students|Sakai administrators|Instructors','Account |Database |Global |Users (Admin User Management)');
...
insert into requirements_data (jirakey,jiranum,summary,description,audience,component) values ('REQ-267','267','allow calendar entries by clicking the interface','Currently the schedule tool requires users to navigate to a separate window to enter a new calendar event. The norm in many calendars is to click and drag to select the duration of a meeting, or double-clcik a timeframe in the calendar interface to begin adding or editing an entry. <br/>
<br/>
...
insert into requirements_data (jirakey,jiranum,summary,description,audience,component) values ('REQ-289','289','Sakai should allow instructors to combine rosters of two or more sites','Goals:<br/>
...
insert into requirements_data (jirakey,jiranum,summary,description,audience,component) values ('REQ-320','320','Ability to display current term courses','Provide ability for instructors and students to view course sites by term (e.g., by Fall 2005, Winter 2006, Spring 2006, Summer 2006).<br/>
<br/>
...
insert into requirements_data (jirakey,jiranum,summary,description,audience,component) values ('REQ-324','324','Order of left hand tool menu should have default alpha order and be configurable within each site by instructor','For left hand menu of tools:  <br/>
...
','Sakai administrators',' New Tool');
insert into requirements_data (jirakey,jiranum,summary,description,audience,component) values ('REQ-331','331','Resources tool should allow for different access to documents for different users','Allow users to identify who is allowed to access information within Resources based on a drop-down class list. (particularly useful for sharing/collaboration on papers/projects).','Instructors|Sakai administrators|Students','Realms (Admin Site Management)|Resources ');
...
insert into requirements_data (jirakey,jiranum,summary,description,audience,component) values ('REQ-334','334','Sakai should provide statistics (distribution, histogram) for each grade item ','Provide statistics for each grade item (e.g., distribution, histogram)','Sakai administrators|Instructors','Gradebook ');
...
insert into requirements_data (jirakey,jiranum,summary,description,audience,component) values ('REQ-347','347','Cross tool integration should be improved.','Tools should be be better integrated with one another, eg:  <br/>
...
insert into requirements_data (jirakey,jiranum,summary,description,audience,component) values ('REQ-348','348','Samigo should automatically allow for alternate numerical forms in grading questions','The Assessment creation tool should allow for alternate valid representations of a numerical answer without requiring the answer to be an exact textual match.  For example it would be useful to the sciences for the system to recognize that 0.00357 and 3.57E-3 are equivalent.','Students|Instructors','Samigo - Authoring |Samigo - Delivery |Samigo - Global ');
...
insert into requirements_data (jirakey,jiranum,summary,description,audience,component) values ('REQ-351','351','Assignments should allow instructors to create assignments that do not require a submission','Goals:<br/>
...
insert into requirements_data (jirakey,jiranum,summary,description,audience,component) values ('REQ-363','363','The Sakai portal should not force the use of iframes','From last year''s Core Architecture Team discussions:<br/>
<br/>
...
insert into requirements_data (jirakey,jiranum,summary,description,audience,component) values ('REQ-364','364','Applications and services need easier access to richer institutional data','Required LMS functionality is missing from Sakai, including but not restricted to the following:<br/>
<br/>
...
insert into requirements_data (jirakey,jiranum,summary,description,audience,component) values ('REQ-384','384','Dynamically targetted announcements','Sometimes one wants to communicate something to a subset of all Sakai users, for example:<br/>
<br/>

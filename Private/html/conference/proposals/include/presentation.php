 ...
 * Created on Mar 18, 2006 by @author az
...
$vItems = array();
$vItems['p_title'] = "required";
$vItems['p_abstract'] = "required";
$vItems['p_desc'] = "required";
$vItems['p_speaker'] = "required";
$vItems['bio'] = "required";
$vItems['co_speaker'] = "required";
$vItems['co_bio'] = "required";
$vItems['p_URL'] = "required";
$vItems['p_track'] = "required";
$vItems['p_format'] = "required";
...
if ($_POST['save']) { // saving the form
	...
	if ($errors == 0) {
		...
		/*
		$_SESSION['audience_dev']=$_POST['audience_0'];
		$_SESSION['audience_ui_dev']=$_POST['audience_1'];
		$_SESSION['audience_support']=$_POST['audience_2'];
		$_SESSION['audience_faculty']=$_POST['audience_3'];
		$_SESSION['audience_faculty_dev']=$_POST['audience_4'];
		$_SESSION['audience_implementors']=$_POST['audience_5'];
		$_SESSION['audience_instruct_dev']=$_POST['audience_6'];
		$_SESSION['audience_librarians']=$_POST['audience_7'];
		$_SESSION['audience_managers']=$_POST['audience_8'];
		$_SESSION['audience_sys_admin']=$_POST['audience_9'];
		$_SESSION['audience_univ_admin']=$_POST['audience_10'];
		...
		*/
		...
		include('includes/submit_presentation.php');
		
		if($result) {
			$num_pres=$_SESSION['num_pres']++;
			include ('includes/send_proposalEmail.php');
    ...
    <table width="100%" cellpadding="0" cellspacing="0">
      <tr>
		<td colspan="2" style="padding:4px;">
        	<strong> Proposal for Conference Presentation </strong><br/>
        	Select the most appropriate Presentation Topic Areas, Intend Audiences, and 
        	Format for your presentation from the options provided below.
        	Please note that these classifications and titles will be used by the 
        	program commitee for the proposal review and conference planning process, 
        	and may not be the classifications or titles used for the final conference program.
      ...
      <tr>
      	<td nowrap="true">
        	...
        	<img id="p_titleImg" src="/accounts/ajax/images/blank.gif" width="16" height="16" alt="indicator"/>
      	</td>
        <td>
        	<input type="text" name="p_title" size="40" maxlength="75" value="<?php echo $_POST['p_title'];?>" />
        	<br />(75 max chars)
			<input type="hidden" id="p_titleValidate" value="<?= $vItems['p_title'] ?>"/>
			<span id="p_titleMsg"></span>
        </td>
      </tr>
      ...
      <tr>
		<td colspan=2>
        	...
        	<img id="p_abstractImg" src="/accounts/ajax/images/blank.gif" width="16" height="16" alt="indicator"/>
			(50 word max.)<br />
			This summary will appear on the conference program. <br />
			<br />
			<textarea name="p_abstract" cols="75" rows="6"><?php echo $_POST['p_abstract'];?></textarea><br />
			<input type="hidden" id="p_abstractValidate" value="<?= $vItems['p_abstract'] ?>"/>
			<span id="p_abstractMsg"></span>
		</td>
      </tr>
      ...
      <tr>
        <td colspan=2>
			...
			<img id="p_descImg" src="/accounts/ajax/images/blank.gif" width="16" height="16" alt="indicator"/>
        	(150 word max.)<br />
        	This description is used by the program committee for a more in-depth 
			review of your session.<br />
			<textarea name="p_desc" cols="75" rows="6" ><?php echo $_POST['p_desc']; ?></textarea>
			<input type="hidden" id="p_descValidate" value="<?= $vItems['p_desc'] ?>"/>
			<span id="p_descMsg"></span>
		</td>
      </tr>

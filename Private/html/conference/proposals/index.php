...
$AUTH_MESSAGE = "You must login to register for the $CONF_NAME conference or to submit a conference proposal. If you do not have an account, please create one.";

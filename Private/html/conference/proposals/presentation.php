    ...
    <table width="100%" cellpadding="0" cellspacing="0">
      ...
      <tr>
		<td colspan=2>
			...
			<br />
			<textarea name="p_abstract" cols="75" rows="6"><?php echo $_POST['p_abstract'];?></textarea>
			<br />
		</td>
      </tr>
      ...
      <div id="co_presenters">  List the names of your co-presenters, one name per line. 
       <textarea name="co_speaker" cols="60" rows="4" value="<?php echo $_POST['co_speaker']; ?>" maxlength="200"/><?php echo $_POST['co_speaker']; ?></textarea><br /></span>
          </div></td>
      </tr>
      <!--<tr>

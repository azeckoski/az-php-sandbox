...
<div id=outerright>
	<div id=rightcol>
	    ...
	    <div><br />
	      <a href="/facebook/"><img src="<?= $TOOL_PATH ?>/include/images/facebook.jpg" height="75" width="130" alt="Sakai facebook" border="0"/></a><br />
	      <br />
	      ...
	      <br />
	      <strong>Please take the time now to <a href="/facebook/">add your photo to the facebook.</a><br />
	      </strong> <br />
	    </div>
	</div> <!--end rightcol -->
</div> <!-- end outerright -->

...
name="comment_form" id="comment_form">
 <td>	<strong>Rank this session:</strong><br/><input id="vr6_2" name="vr6" type="radio" value="2"  onClick="checkSaved('6')" title="Can use Sakai but need this as soon as possible"><label for="vr6_2" title="Can use Sakai but need this as soon as possible">green</label><br />

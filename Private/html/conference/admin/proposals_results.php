...
<tr class="<?= $linestyle ?>" valign="top">
	<td style="padding-left:1px;" ><div><strong style="text-align:center;font-size: 1.1em; border:1px dotted #333333; background:#e9d06f; margin:0; margin-right:2px; padding: 3px 3px; "><?=$item['order']?></strong>&nbsp;</div></td>
